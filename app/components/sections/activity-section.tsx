  ...
  return (
    ...
    >
      <div className="flex flex-col py-5 bg-accent/60 border-transparent text-accent-foreground rounded-lg gap-5">
        ...
        <div className="flex flex-col">
          <h3 className="text-xs font-extrabold uppercase mx-5">Activities</h3>
          {activities.length > 0 ? (
            <ScrollArea
              ref={activityRef}
              className="h-[20rem] relative flex flex-col justify-center"
            >
            ...
            <div className="italic ml-5 mt-2 text-neutral-400">He is currently offline :)</div>
          )}
        </div>
      </div>
    </SectionWindow>

...
interface NavigationData {
  navbar: { href: string; icon: React.ComponentType<IconProps>; label: string }[];
  contact: {
    social: {
      name: string;
      url: string;
...
export function DockNav() {
  return (
    <TooltipProvider>
      <Dock direction="bottom" iconMagnification={47}>
        ...
        {Object.entries(navigation.contact.social).map(([_, social]) => (
